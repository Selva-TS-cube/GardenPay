...
import GardenPayLogo from "./icons/GardenPaywhite.png";
    ...
    <div>
      <style>
        ...
        .sidebar {
          width: 180px;
          height: 100%;
          border-right: 1px solid transparent; /* Make border transparent */
          background: #eff2f41a;
          color: #b3b3b3;
          display: flex;
          flex-direction: column;
          ...
          width: 1px;
          height: 100%;
          box-shadow: 0 0 20px 2px #fff; /* Apply glow effect */
      ...
      <div className="dashboard">
        ...
        <Content logo={GardenPayLogo} name={"Dashboard"}>
